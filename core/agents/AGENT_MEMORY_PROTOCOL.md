...
- `core/extensibility/REFINEMENT_RELATIONSHIP_POLICY.md` - Preserve-original and relationship rules
- `core/orchestrator/distribution/DISTRIBUTION_SYNC_SPEC.md` - Current distribution sync boundary
